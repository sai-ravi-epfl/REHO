...
if __name__ == '__main__':
    ...
    weather.data_centre_profile(size= 90000)
    ...
    cl = Clustering(data=df_annual, nb_clusters=nb_clusters, option={"year-to-day": True, "extreme": []},
                    pd=cluster['PeriodDuration'])
    cl.run_clustering()
    ...
    scenario['enforce_units'] = ['ORC_EPFL_district'] #'HeatPump_Geothermal_district','DHN_out_district','Battery_district','PV_district','ORC_EPFL_district'
    scenario["specific"] = ["enforce_PV_max"]

    # Initialize available units and grids
    grids = infrastructure.initialize_grids({'Electricity': {"Cost_demand_cst": 0.08, "Cost_supply_cst": 0.08},"Data": {"Cost_demand_cst": 0.0001, "Cost_supply_cst": 0.0002},"Heat": {"Cost_demand_cst": 0.0001, "Cost_supply_cst": 0.0002,  "GWP_supply_cst": 0}})  #'NaturalGas': {"Cost_demand_cst": 0.01, "Cost_supply_cst": 0.10},
