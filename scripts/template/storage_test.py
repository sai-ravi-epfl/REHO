...
if __name__ == '__main__':
    ...
    #
    #
    scenario['enforce_units'] = ['Battery_interperiod', 'NG_Boiler_district'] #'HeatPump_Geothermal_district','DHN_out_district','Battery_district','PV_district',
    scenario["specific"] = []
    ...
    grids = infrastructure.initialize_grids({'Electricity': {"Cost_demand_cst": 0.08, "Cost_supply_cst": 0.08},
                                            "Heat": {"Cost_demand_cst": 0.0001, "Cost_supply_cst": 0.0002,  "GWP_supply_cst": 0},
                                             'NaturalGas': {"Cost_demand_cst": 0.01, "Cost_supply_cst": 0.10}})  #'NaturalGas': {"Cost_demand_cst": 0.01, "Cost_supply_cst": 0.10},
    ...
    # Set method options
    method = {'building-scale': True,'save_stream_t': True, 'use_dynamic_emission_profiles': True, 'save_streams': True, 'use_Storage_Interperiod': True, 'ORC_all_the_time': False} #, 'use_pv_orientation': True
    # Run optimization
    ...
    plotting.plot_sankey_1(reho.results['totex'][0], label='EN_long', color='ColorPastel').show()
