...
if __name__ == '__main__':
    ...
    weather.data_centre_profile(size = 8000)
    ...
    #
    #
    scenario['enforce_units'] = ['ORC_EPFL_district','Battery_district', 'TES_intraday_district'] #'HeatPump_Geothermal_district','DHN_out_district','Battery_district','PV_district',
    ...
    # Set method options
    method = {'building-scale': True,'save_stream_t': True, 'use_dynamic_emission_profiles': True, 'save_streams': True, 'ORC_all_the_time': False,"Link_DC_to_district_PV": True} #, 'use_pv_orientation': True
    # Run optimization
    reho = REHO(qbuildings_data=qbuildings_data, units=units,parameters=parameters, grids=grids, cluster=cluster, scenario=scenario, method=method, solver ='gurobi') #parameters=parameters,, DW_params=DW_params
