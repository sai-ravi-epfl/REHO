...
from manipluateLoadDC.data_heat_switch_init_before_clustering import *
...
if __name__ == '__main__':
   ...
   # Select weather data
    ...
    parameters = {'Cooling': np.array([0.0]),'n_vehicles': np.array([0.0]), 'T_DHN_supply_cst': np.repeat(70.0, n_house),'T_DHN_return_cst': np.repeat(60.0, n_house), 'elec_demand_datacentre': data_centre_heat_profile, 'TransformerCapacity': np.array([1e8, 1e8,0]) } #, 'Network_supply_heat': np.array([0.0])
    #parameters = {}
    ...
    # Save results
    filename='ALL_EPFL_ORC_50kW_DC_1_test'
