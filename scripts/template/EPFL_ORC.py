...
if __name__ == '__main__':
    ...
    # Set method options
    method = {'building-scale': True,'save_stream_t': True, 'use_dynamic_emission_profiles': True, 'save_streams': True, 'ORC_all_the_time': False,"Link_DC_to_district_PV": False} #, 'use_pv_orientation': True
    # Run optimization
    ...
    # Save results
    filename='tank_orc_nt_ns_new_eff'
