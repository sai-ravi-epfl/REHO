...
def data_centre_profile(size): # size to be mentioned in kW
    df_load_profile = pd.read_csv(r'C:\Users\there\Desktop\REHO2\scripts\template\data\profiles\data_centre_hourly_week.csv')
...
# Prepare data in the format for CSV
    ...
    csv_filename = 'C:/Users/there/Desktop/REHO2/reho/data/weather/yearly_data_centre_profile_repeated.csv'
