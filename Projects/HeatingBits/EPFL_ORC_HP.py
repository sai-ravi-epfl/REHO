...
if __name__ == '__main__':
    ...
    n_house = 53
    qbuildings_data = reader.read_csv(buildings_filename='/Users/eduardo/REHO_local/REHO-HeatingBits/REHO/scripts/template/data/EPFL_2.csv', nb_buildings= n_house)
    ...
    parameters = {'n_vehicles': np.array([0.0]), 'T_DHN_supply_cst': np.repeat(70.0, n_house),'T_DHN_return_cst': np.repeat(60.0, n_house),"TransformerCapacity": np.array([1e8, 1200])}
    #parameters = {}
