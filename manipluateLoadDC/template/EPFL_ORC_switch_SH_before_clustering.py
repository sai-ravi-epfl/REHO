...
if __name__ == '__main__':
    ...
    output_path_SH = r'C:\\Users\\there\\Desktop\\REHO2\\scripts\\templates\\yearly_data_centre_profile_repeated.csv'
    size = 2000

    total_SH, shifted_load_df_SH, heating_data = process_and_optimize_data(path_to_load_profile, path_to_excel_file_BAU, model_path_SH, output_path_SH,'House_Q_heating',size)
    ...
    # Save results
    filename='ALL_EPFL_ORC_switch_gwp_50kW_DC_1'
