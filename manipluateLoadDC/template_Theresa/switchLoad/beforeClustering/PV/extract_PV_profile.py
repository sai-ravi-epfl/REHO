...
### File Paths
excel_file_path = path_to_results + '/ALL_EPFL_BAU_16clusters_24_hours_2MWDC_TIED_gwp.xlsx' #replace by excel file path with typical days from REHO
dat_file_path = path_to_clustering + '/index_Pully_16_24_T_I_E_D.dat' #index dat file from clustering
output_csv_path = 'reconstructed_year_16clusters_new.csv' # path and name of where you want to store your yearly profile as a csv
number_periods = 16 + 1
