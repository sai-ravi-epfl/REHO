...
path_to_load_profile_dat = r'/scripts/template_Sai/data/clustering/D_Pully_10_24_T_I_E_D.dat'
load_profile = pd.read_csv(path_to_load_profile_dat, sep='\t', header=None, engine='python')
path_to_emissions = r'/reho/data/emissions/electricity_matrix_2019_reduced.csv'
path_timestamp_dat = r'/scripts/template_Sai/data/clustering/timestamp_Pully_10_24_T_I_E_D.dat'
model_path_gwp = r'/scripts/template_Theresa/switchLoad/afterClustering/data_heat_switch_after_clustering_gwp.mod'
output_single_column_dat_path_GWP = r'/scripts/template_Theresa/switchLoad/D_Pully_10_24_T_I_E_D.dat'
...
path_to_load_profile_dat = r'/scripts/template_Sai/data/clustering/D_Pully_10_24_T_I_E_D.dat'
path_to_excel_file_BAU = r'/scripts/template_Sai/results/ALL_EPFL_BAU_gwp.xlsx'
model_path_SH = r'/scripts/template_Theresa/switchLoad/afterClustering/data_heat_switch_after_clustering_use.mod'
output_single_column_dat_path_SH = r'/scripts/template_Theresa/switchLoad/D_Pully_10_24_T_I_E_D.dat'
...
path_to_load_profile_dat = r'/scripts/template_Sai/data/clustering/D_Pully_10_24_T_I_E_D.dat'
path_to_excel_file_BAU = r'/scripts/template_Sai/results/ALL_EPFL_BAU_gwp.xlsx'
model_path_electricity_demand = r'/scripts/template_Theresa/switchLoad/afterClustering/data_heat_switch_after_clustering_use.mod'
output_single_column_dat_path_electricity_demand = r'/scripts/template_Theresa/switchLoad/D_Pully_10_24_T_I_E_D.dat'
