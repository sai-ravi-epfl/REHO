"""
Input:
- pickle_files: List of paths to pickle files containing data.

Functionality:
1. read_pickle_file(file_path): Reads a pickle file and returns the data.
2. Processes each pickle file to extract and calculate relevant data.
3. Aggregates results into a DataFrame and saves it to a CSV file.
4. Plots the results, showing electricity consumption and heat supply ratios.
"""
...
### Electricity
    ...
    # Electricity demand of the data centre
