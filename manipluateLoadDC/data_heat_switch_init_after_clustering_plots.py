...
path_to_load_profile_dat = r'C:\\Users\\there\\Desktop\\REHO2\\scripts\\template\\data\\clustering\\D_Pully_10_24_T_I_E_D.dat'
load_profile = pd.read_csv(path_to_load_profile_dat, sep='\t', header=None, engine='python')
...
model_path_gwp = r'C:\Users\there\Desktop\REHO2\scripts\templates\switchLoad\data_heat_switch_after_clustering_gwp.mod'
output_single_column_dat_path_GWP = r'C:\\Users\\there\\Desktop\\REHO2\\scripts\\templates\\switchLoad\\D_Pully_10_24_T_I_E_D.dat'
...
model_path_SH = r'C:\Users\there\Desktop\REHO2\scripts\templates\switchLoad\data_heat_switch_after_clustering_use.mod'
output_single_column_dat_path_SH = r'C:\\Users\\there\\Desktop\\REHO2\\scripts\\templates\\switchLoad\\D_Pully_10_24_T_I_E_D.dat'
...
path_to_load_profile_dat = r'C:\\Users\\there\\Desktop\\REHO2\\scripts\\template\\data\\clustering\\D_Pully_10_24_T_I_E_D.dat'
path_to_excel_file_BAU = r'C:\Users\there\Desktop\REHO2\scripts\template\results\ALL_EPFL_BAU_gwp.xlsx'
model_path_electricity_demand = r'C:\Users\there\Desktop\REHO2\scripts\templates\switchLoad\data_heat_switch_after_clustering_use.mod'
output_single_column_dat_path_electricity_demand = r'C:\\Users\\there\\Desktop\\REHO2\\scripts\\templates\\switchLoad\\D_Pully_10_24_T_I_E_D.dat'
...
ax1.xaxis.set_major_locator(plt.MultipleLocator(24))
ax2 = ax1.twinx()
ax2.plot(electricity_data[:242], linestyle='-', marker='', color='g', linewidth=1.5, label='Electricity Demand')
ax2.set_ylim(bottom=0)
