...
if __name__ == '__main__':
    ...
    path_to_data_centre_heat_profile = r'/scripts/template/data/clustering/D_Pully_10_24_T_I_W_D.dat'
    ...
    output_single_column_dat_path_GWP = r'/scripts/template/data/clustering/D_Pully_10_24_T_I_W_D.dat'
