...
def process_and_optimize_data_GWP(path_to_load_profile_dat, path_to_emissions, path_timestamp_dat, model_path, output_single_column_dat_path):
    ...
    path_timestamp_csv = r'/scripts/templates/switchLoad/timestamp_with_hour_of_year.csv'
    convert_timestamp_to_csv(path_timestamp_dat, path_timestamp_csv)

    path_hourly_gwp_profile = r'/scripts/templates/switchLoad/gwp_profile_grid.csv'
    path_filtered_data_gwp_dat = r'/scripts/templates/switchLoad/filtered_data_gwp.dat'
...
path_to_load_profile_dat = r'/scripts/templates/data/clustering/D_Pully_10_24_T_I_E_D.dat'
path_to_SH_profile_dat = r'/scripts/templates/switchLoad/space_heating_BAU_GWP.dat'
model_path_SH = r'/scripts/templates/switchLoad/data_heat_switch_after_clustering_use.mod'
...
path_to_load_profile_dat = r'/scripts/templates/data/clustering/D_Pully_10_24_T_I_E_D.dat'
path_to_electricity_demand_profile_dat = r'/scripts/templates/switchLoad/electricity_demand_BAU_GWP.dat'
