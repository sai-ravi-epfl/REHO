...
subject to BAT_energy_balance_IP{u in UnitsOfType['Battery_interperiod'], hy in Year}:
...
#-- Power constraints
subject to BAT_c3_IP{u in UnitsOfType['Battery_interperiod'],p in Period,t in Time[p]}:
Units_demand['Electricity',u,p,t]*dt[p] <= (BAT_limit_ch_IP[u]-BAT_limit_di_IP[u])*Units_Mult[u]*C_rate_IP[u];

subject to BAT_c4_IP{u in UnitsOfType['Battery_interperiod'],p in Period,t in Time[p]}:
