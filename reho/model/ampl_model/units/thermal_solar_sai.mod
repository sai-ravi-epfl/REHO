...
param STC_module_size{u in UnitsOfType['ThermalSolar']}>=0 default 2.32;		#m2		Viessmann
param STC_a{u in UnitsOfType['ThermalSolar']}>=0 default 4.16;				#W/m2 K 	SPF (Viessmann, Vitosol 200-F)
param STC_b{u in UnitsOfType['ThermalSolar']}>=0 default 0.0073;				#W/m2 K2	SPF (Viessmann, Vitosol 200-F)
